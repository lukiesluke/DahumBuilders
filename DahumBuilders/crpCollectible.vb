...
Public Class crpCollectible
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DahumBuilders.crpCollectible.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpCollectible
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpCollectible = New crpCollectible()
        rpt.Site = Me.Site
        Return rpt
    End Function
