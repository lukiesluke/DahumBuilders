...
Public Class crpExpensesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DahumBuilders.crpExpensesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpExpensesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpExpensesReport = New crpExpensesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
