...
Public Class crpSalesReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DahumBuilders.crpSalesReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpSalesReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpSalesReport = New crpSalesReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
