...
Public Class crpSummaryReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DahumBuilders.crpSummaryReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpSummaryReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpSummaryReport = New crpSummaryReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
