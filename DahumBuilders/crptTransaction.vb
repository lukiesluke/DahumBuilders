...
Public Class crptTransaction
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DahumBuilders.crptTransaction.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrptTransaction
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crptTransaction = New crptTransaction()
        rpt.Site = Me.Site
        Return rpt
    End Function
